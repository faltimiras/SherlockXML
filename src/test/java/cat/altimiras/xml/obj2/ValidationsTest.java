...
public class ValidationsTest {
	...
	public void noValidatesDTD() throws Exception {
		...
		XMLParser<SimpleTestObj> parser = new WoodStoxObjParserImpl2<>(SimpleTestObj.class, ci, false);
	...
	public void validatesDTD() throws Exception {
		...
		String xml = IOUtils.toString(this.getClass().getResourceAsStream("/withDTDNoExist.xml"), "UTF-8");
		XMLParser<SimpleTestObj> parser = new WoodStoxObjParserImpl2<>(SimpleTestObj.class, ci, true);
