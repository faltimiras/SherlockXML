...
public class AnnotationsTest {
	...
	public void xmlAnnotationTest() throws Exception {
		...
		XMLParser<SimpleAnnotationTestObj> parser = new WoodStoxObjParserImpl2<>(SimpleAnnotationTestObj.class, ci);
	...
	public void xmlNestedAnnotationTest() throws Exception {
		...
		XMLParser<NestedAnnotationTestObj> parser = new WoodStoxObjParserImpl2<>(NestedAnnotationTestObj.class, ci);
