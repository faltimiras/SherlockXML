...
public class ListsTest {
	...
	public void xmlListTest() throws Exception {
		...
		XMLParser<ListTestObj> parser = new WoodStoxObjParserImpl2<>(ListTestObj.class, ci);
	...
	public void xmlListNestedTest() throws Exception {
		...
		XMLParser<Nested4TestObj> parser = new WoodStoxObjParserImpl2<>(Nested4TestObj.class, ci);
	...
	public void xmlListPrimitivesTest() throws Exception {
		...
		XMLParser<ListPrimitivesObj> parser = new WoodStoxObjParserImpl2<>(ListPrimitivesObj.class, ci);
	...
	public void xmlListPrimitives2Test() throws Exception {
		...
		XMLParser<Nested7TestObj> parser = new WoodStoxObjParserImpl2<>(Nested7TestObj.class, ci);
	...
	public void xmlListPrimitivesNoWrapperTest() throws Exception {
		...
		assertEquals(2, o.getValues().size());
		assertEquals(new Integer(8), o.getValues().get(0));
		assertEquals(new Integer(9), o.getValues().get(1));
		assertFalse(o.isIncomplete());
	}
	...
	public void xmlListNoWrapperWithAttributesTest() throws Exception {
		...
		XMLParser<ListTestObj2> parser = new WoodStoxObjParserImpl2<>(ListTestObj2.class, ci);
	...
	public void xmlListNoWrapper() throws Exception {
		...
		XMLParser<Nested8TestObj> parser = new WoodStoxObjParserImpl2<>(Nested8TestObj.class, ci);
	...
	public void xmlNoWrapperConsecutiveLists(String file) throws Exception {
		...
		XMLParser<Nested9TestObj> parser = new WoodStoxObjParserImpl2<>(Nested9TestObj.class, ci);
	...
	public void xmlNestedNoWrapperConsecutiveLists() throws Exception {
		...
		XMLParser<Nested10TestObj> parser = new WoodStoxObjParserImpl2<>(Nested10TestObj.class, ci);
