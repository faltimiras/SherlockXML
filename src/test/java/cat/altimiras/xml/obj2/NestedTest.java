...
public class NestedTest {
	...
	public void xmlNestedTest() throws Exception {
		...
		XMLParser<NestedTestObj> parser = new WoodStoxObjParserImpl2<>(NestedTestObj.class, ci);
	...
	public void xmlNestedLoopTest() throws Exception {
		...
		XMLParser<NestedLoopTestObj> parser = new WoodStoxObjParserImpl2<>(NestedLoopTestObj.class, ci);
